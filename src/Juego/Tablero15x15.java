...
public class Tablero15x15 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(lblCierre);

        getContentPane().add(jPanel3);
        jPanel3.setBounds(800, 520, 170, 50);
    ...
    private void MoverFicha1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MoverFicha1ActionPerformed
        Movimientospj215x15 Player1 = new Movimientospj215x15(PJ1ficha1,Turno,GirarDado2, PJ2);
        Player1.start();
        MoverFicha1.setVisible(false);
    ...
    private void MoverFicha2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MoverFicha2ActionPerformed
        Movimientospj115x15 Player2 = new Movimientospj115x15(PJ1ficha2,Turno,GirarDado1,PJ1);
        Player2.start();
        MoverFicha2.setVisible(false);
