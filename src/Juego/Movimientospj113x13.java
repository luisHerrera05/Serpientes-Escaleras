...
public class Movimientospj113x13 extends Thread {
    ...
    public Movimientospj113x13(JLabel FigFicha, JLabel SigTurno, JButton botongirar, JLabel nombreTurno){
    ...
    public void run(){
        ...
        if(FigFicha.getX()==567){
            if(entero == 1){
                ...
                Logger.getLogger(Movimientospj113x13.class.getName()).log(Level.SEVERE, null, ex);}
                }
            }
            if(entero == 2){
                for(int w = 0; 130 > w; w++){
